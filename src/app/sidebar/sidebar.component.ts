...
var mda: any = {
    ...
    initMovingTab: function(){
       mda.movingTab = $(mda.movingTab);
        try {  
           mda.sidebarMenuActive = $('.sidebar sidebar-cmp  .nav-container > .nav > li.active > a:not([data-toggle="collapse"]');
            console.log(mda.sidebarMenuActive );
           if(mda.sidebarMenuActive != null){
           if(mda.sidebarMenuActive.length != 0){
               mda.setMovingTabPosition(mda.sidebarMenuActive);
           } else {
               mda.sidebarMenuActive = $('.sidebar sidebar-cmp  .nav-container .nav > li.active .collapse li.active > a');
               mda.isChild = true;
           ...
           if (window.history && window.history.pushState) {
            ...
            console.log("error al llamar al elemento");
        } 
